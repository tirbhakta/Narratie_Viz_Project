...
function countryGraph(country){
    ...
    //var parseDate = d3.timeParse("%Y-%m-%d");
        ...
        d3.csv(`../World_Covid_Data.xlsx`, function(error ,data_entry) {
        ...
        data.push({
            value: data_entry[i].total_confirmed,
            value_rec: data_entry[i].total_recovered,
            value_active: data_entry[i].active_cases,
            value_dead: data_entry[i].total_deaths,
        })

        ordinals.push(data_entry[i].location)
        }
        ...
        let yScale = y.domain([0, d3.max(data, function(d,i){return data[i].value})])
